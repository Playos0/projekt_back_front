...
// Reguły walidacji (poprawione na standardowy format)
const emailRules = [
...
<template>
  ...
  <div class="d-flex flex-row v-screen-height" style="height: 100vh;">
    ...
    <!-- Left side -->
    <div class="bg-teal-darken-4 d-none d-md-flex align-center  justify-center"  style="width: 30%;">
      <div class=" d-flex-row bg-teal-darken-3 border-thin rounded-lg pa-6 text-center">
    ...
    <!-- right side -->
    <div class="bg-black flex-grow-1 d-flex align-center justify-center">
      
      <v-form v-model="valid" style="width: 100%; max-width: 500px;">
        <v-container>
          <!-- form -->
          <v-row class="flex-column border-thin rounded-lg pa-6 text-center bg-grey-lighten-5 ma-4">
            <h1 class="text-h4 mb-6">Creating new account</h1>
